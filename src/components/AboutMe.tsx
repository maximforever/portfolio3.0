  ...
  return (
    <div>
      <p>
        ...
        I am currenrly working on <a href="https://www.executeprogram.com" target="_blank" rel="nofollow noreferrer"> Execute Program</a> and writing for the <a href="https://stackoverflow.blog/authors/maxpekarsky/" target="_blank" rel="nofollow noreferrer"> StackOverflow blog</a>.
